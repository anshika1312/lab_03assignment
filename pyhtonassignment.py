...
if __name__ == "__main__":
    process_table = FlightTable()

    process_table.add_process(Flight("P1", "VSCode", 100, "MID"))
    process_table.add_process(Flight("P23", "Eclipse", 234, "MID"))
    process_table.add_process(Flight("P93", "Chrome", 189, "High"))
    process_table.add_process(Flight("P42", "JDK", 9, "High"))
    process_table.add_process(Flight("P9", "CMD", 7, "High"))
    process_table.add_process(Flight("P87", "NotePad", 23, "Low"))
